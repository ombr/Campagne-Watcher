Raphael.fn.pieChart = function (cx, cy, r, values, labels, stroke) {
    ...
    var angle = 0,
		...
		bcolor=clr[j],
                ...
                txt = paper.text(cx + (r + delta + 55) * Math.cos(-popangle * rad), cy + (r + delta + 25) * Math.sin(-popangle * rad), labels[j]).attr({fill: bcolor, stroke: "none", opacity: 1, "font-family": 'Fontin-Sans, Arial', "font-size": "20px"});
